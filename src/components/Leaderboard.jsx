    ...
    <div className="leaderboard-container">
      ...
      <div className="leaderboard-subtabs" style={{
        ...
        <button
          ...
          style={{
            flex: 1,
            backgroundColor: subTab === "scores" ? "var(--bg-input)" : "transparent",
        ...
        <button
          ...
          style={{
            flex: 1,
            backgroundColor: subTab === "trophies" ? "var(--bg-input)" : "transparent",
      ...
      {subTab === "scores" && (
        <div className="scores-tab-content animate-fade-in">
          ...
          <div className="leaderboard-list">
            {sortedPlayers.map((player, index) => {
              ...
              return (
                <div key={player.name} className={`leaderboard-row ${player.isZombie ? "row-zombie" : ""}`}>
                  ...
                  <div className="row-right">
                    ...
                    <span className="row-score">{player.score} pts</span>
                  </div>
                </div>
              );
            })}
      ...
      {/* --- SUB-TAB 2 : TROPHIES --- */}
      {subTab === "trophies" && (
        <div className="trophies-tab-content animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
