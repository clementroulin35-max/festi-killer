...
export default function CounterAttackTab({ playerName }) {
  ...
  if (hasPendingCounter) {
    return (
      <div className="counter-screen-layout" style={{ paddingTop: "64px", paddingBottom: "80px", display: "flex", justifyContent: "center", alignItems: "center" }}>
  ...
  return (
    <div className="counter-screen-layout" style={{ paddingTop: "64px", paddingBottom: "80px" }}>
